...
parser.add_argument("--factor_inter", default=0.01, type=float, help="factor for inter-class sKLD")
...
class Discoverer(pl.LightningModule):
    ...
    def training_step(self, batch, _):
        ...
        loss = (loss_cluster + loss_overcluster) / 2 + inter_loss * self.hparams.factor_inter
